...
#SBATCH --nodes=1
    ...
    # Name and location of experiment output on HPSS
        ...
        exp_new=ufs_hr3b
	exp_new=GFSv16
        upload_root=/scratch1/NCEPDEV/stmp2/Lydia.B.Stefanova/fromHPSS/$exp_new        # specify location of  grib2 files uploaded from HPSS
	upload_root=$noscrub/$exp_new
...
#        res=Orig                                                                       # Orig: use sfluxgrb
	...
	#declare -a varlist_surface=("land" "sst" "tmpsfc" "tmp2m" "t2min" "t2max" "ulwrftoa" "snow" "snod" "weasd" "dswrf" "dlwrf" "uswrf" "ulwrf" "cloudtot" "cloudbdry" "cloudlow" "cloudmid" "cloudhi" "icetk" "icec" "prate" "pwat" "spfh2m" "tsoil010cm" "soilw010cm" "weasd" "snow" "gflux" "sfexc" "lhtfl" "shtfl" "sbsno" "hpbl"  "soill010cm"  "u10" "v10" "soilw010cm" "albdo" "pres" "sfcr")
	#declare -a varlist_upper=("CAPE" "u850" "z500" "u200" "u925" "v925" "spfh925" "tlowest" "gust" "land" "tmpsfc" "tmp2m" "t2min" "t2max" "ulwrftoa" "snow" "snod" "weasd" "dswrf" "dlwrf" "uswrf" "ulwrf" "cloudtot" "cloudbdry" "cloudlow" "cloudmid" "cloudhi" "icetk" "icec" "prate" "pwat" "spfh2m" "tsoil010cm" "soilw010cm" "weasd" "snow" "gflux" "sfexc" "lhtfl" "shtfl" "sbsno" "hpbl"  "soill010cm"  "u10" "v10" "soilw010cm" "albdo" "pres" "sfcr")
	#declare -a varlist_upper=("t850" "rh1000" "rh850")
	declare -a varlist_surface=("uswrftoa")
    # The plotting scripts are prepared to handle variables on the list below:
        oknames=(land tlowest tmpsfc tmp2m t2min t2max ulwrftoa uswrftoa dlwrf dswrf ulwrf uswrf prate pwat icetk icec cloudbdry cloudlow cloudmid cloudhi snow weasd snod lhtfl shtfl pres u10 v10 uflx vflx tsoil12m soilm02m sfcr spfh2m u925 v925 spfh925 t850 u850 v850 z500 u200 v200 cloudtot vgtyp sbsno tsoil010cm soilw010cm gflux sfexc albdo hpbl CAPE sst ustar gust rh850 rh1000 cprat soill010cm)
