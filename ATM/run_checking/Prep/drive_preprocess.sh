...
#SBATCH --nodes=1
    ...
    # Specify list of variables to preprocess (turn from 6-hourly grib2 into a 35-day series of daily netcdf); 
        ...
        declare -a varlist_surface=("land" "tmpsfc" "tmp2m" "t2min" "t2max" "ulwrftoa" "snow" "snod" "weasd" "dswrf" "dlwrf" "uswrf" "ulwrf" "cloudtot" "cloudbdry" "cloudlow" "cloudmid" "cloudhi" "icetk" "icec" "prate" "pwat" "spfh2m" "tsoil010cm" "soilw010cm" "weasd" "snow" "gflux" "sfexc" "lhtfl" "shtfl" "sbsno" "hpbl"  "soill010cm"  "u10" "v10" "soilw010cm")
