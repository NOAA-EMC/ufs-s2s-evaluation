...
if __name__ == "__main__":
    ...
    ap.add_argument('-i1', '--input1', help="path to MLD data file", required=True)
    ...
    ap.add_argument('-v', '--variable', help="variable name to plot of MLD data file, MLD (003) is set for modle)", required=True)
